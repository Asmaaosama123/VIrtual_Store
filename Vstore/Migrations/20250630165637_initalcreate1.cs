        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Delete_Reason = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FavList_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavLists", x => x.FavList_Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Shop_Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavListShops", x => new { x.Owner_Id, x.FavList_Id });
                    table.ForeignKey(
                        name: "FK_FavListShops_FavLists_FavList_Id",
                        column: x => x.FavList_Id,
                        principalTable: "FavLists",
                        principalColumn: "FavList_Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FavListShops_Owners_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Product_View = table.Column<int>(type: "int", nullable: false),
                    Material = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Has_Sale = table.Column<bool>(type: "bit", nullable: false),
                    Sale_Percentage = table.Column<int>(type: "int", nullable: false),
                    Product_Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefualtImage = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    IsDelete = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Owners_Owner_Id",
                        column: x => x.Owner_Id,
                        principalTable: "Owners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rates", x => new { x.Product_Id, x.User_Id });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Rates_Products_Product_Id",
                        column: x => x.Product_Id,
                        principalTable: "Products",
                        principalColumn: "Product_Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocks_Colors_Color_id",
                        column: x => x.Color_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartItems_Stocks_Stock_Id",
                        column: x => x.Stock_Id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_Products_Products_Product_Id1",
                        column: x => x.Product_Id1,
                        principalTable: "Products",
                        principalColumn: "Product_Id");
                    table.ForeignKey(
                        name: "FK_Order_Products_Stocks_StockId",
                        column: x => x.StockId,
                        principalTable: "Stocks",
                        principalColumn: "Stock_Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavListShops_FavList_Id",
                table: "FavListShops",
                column: "FavList_Id");

            migrationBuilder.CreateIndex(
                name: "IX_FavListShops_OwnerId",
                table: "FavListShops",
                column: "OwnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_Products_Product_Id1",
                table: "Order_Products",
                column: "Product_Id1");

            migrationBuilder.CreateIndex(
                name: "IX_Order_Products_StockId",
                table: "Order_Products",
                column: "StockId");
